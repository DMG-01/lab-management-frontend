...
function Navigation() {
    ...
    return(
        ...
        <div className="dashboard">
            <div><Link to="/dashboard" className="dashLink"><i className="bi bi-people-fill"></i></Link></div>
            ...
            <div><Link to="/referral" className="dashLink"><i className="bi bi-hospital-fill"></i></Link></div>
        </div>
        </>
    ) 
}
